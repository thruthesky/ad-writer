    ...
    KakaoPlus.prototype.main = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, puppeteer.launch({ headless: true })];
                    case 1:
                        browser = _a.sent();
                    ...
                    case 2:
                        ...
                        return [4, this.page.goto('https://www.philgo.com/')];
                    case 3:
                        _a.sent();
                        return [4, this.getTitle()];
                    case 4:
                        _a.sent();
                        return [4, this.getHtmlTitle()];
                    case 5:
                        _a.sent();
