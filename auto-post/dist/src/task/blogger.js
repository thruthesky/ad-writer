...
puppeteer.launch({ headless: argv.browser !== 'true' }).then(function (browser) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, page.goto('https://www.blogger.com/go/signin')];
            case 4:
                _a.sent();
            ...
            case 8:
                _a.sent();
                return [4 /*yield*/, page.waitFor('input[type="password"]')];
            case 9:
                _a.sent();
                return [4 /*yield*/, page.focus('input[type="password"]')];
            case 10:
                _a.sent();
                return [4 /*yield*/, page.type(argv.password)];
            case 11:
                _a.sent();
                return [4 /*yield*/, page.click(this.passwordNextButton)];
            case 12:
                _a.sent();
                return [2 /*return*/];
        }
