            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4, this.captureError("Still in login page after timeout exceeds!")];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6:
                        protocol.send('Waiting for link to compose tweet page.');
                        return [4, this.waitAppear("a[href='/compose/tweet']", 10)];
                    case 7:
                        isLinkReady = _a.sent();
                        if (!!isLinkReady) return [3, 9];
                        return [4, this.captureError('Link not found after timeout!')];
                    case 8:
                        _a.sent();
                        _a.label = 9;
                    case 9:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 17:
                        ...
                        return [4, this.captureError("Tweet not found")];
                    case 18:
                        _a.sent();
                        _a.label = 19;
                    case 19: return [2];
